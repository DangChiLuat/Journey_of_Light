...
public class UI : MonoBehaviour, ISaveManager
{
    ...
    private void Awake()
    {
        ...
        SwitchTo(skillTreeUI); // can goi su kien nay truc tren cay ki nang truoc khi chi dinh cac skill tren cay ki nang 
    ...
    public void SwitchWithKeyTo(GameObject _menu)
    {
        ...
        // activeSeft tra ve true false cho biet game object co hoat dong hay khong
